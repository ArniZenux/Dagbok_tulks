...
if(isset($_POST['submit-new'])){
    ...
    $sql = "INSERT INTO tblVerkefni(Heiti, Stadur, Dagur, Tima_byrja, Tima_endir, Vettvangur) VALUES('$Heiti','$Stadur','$Dagur','$Byrja','$Endir','$Vettvangur');";
              ...
              <form action="" method="POST">
                   <div class="top-row">
                      <div class="field-wrap">
                        ...
                        <input type="type" required autocomplete="off" name="Heiti"/>
                      </div>
                      <div class="field-wrap">
                        <label>
